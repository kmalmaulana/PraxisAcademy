...
import 'package:case_provider/bloc/weather_event.dart';
import 'package:case_provider/bloc/weather_state.dart';
import 'package:case_provider/model/weather.dart';
...
class WeatherBloc extends Bloc<WeatherEvent, WeatherState> {
  ...
  Stream<WeatherState> mapEventToState(
    ...
    if (event is GetWeather) {
      ...
      //yield retunrn functuion buth function didn't stop
