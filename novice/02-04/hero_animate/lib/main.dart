    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Row(
          ...
          children: [
            _buildHero(context, 'images/1.jpeg', 'Deep Clean'),
            _buildHero(context, 'images/2.jpeg', 'Fast Clean'),
            _buildHero(context, 'images/3.jpeg', 'Unyellowing'),
          ],
        ),
      ),
    );
